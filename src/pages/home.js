...
export default function home() {
  const handleClickLinkedin = () => {
    window.location.replace(
      "https://www.linkedin.com/in/jeremiah-william-sebastian-5ab68b117/"
    );
  };

  const handleClickGithub = () => {
    window.location.replace(
      "https://github.com/nervouswilliam?tab=repositories"
    );
  };
  return (
    <>
      <div className={styles.container}>
        ...
        <div className={styles.opening}>
          ...
          <p>
            I am a Computer Science Undergraduate focusing on Software
            Engineering.
            <br />
            I am a full stack engineer, mostly coding in javascript in both
